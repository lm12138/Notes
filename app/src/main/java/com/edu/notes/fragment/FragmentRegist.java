...
import com.edu.notes.component.EditTextWithDel;
import com.edu.notes.component.PaperButton;
import com.edu.notes.utlis.Tools;
import com.edu.notes.MainActivity;
import com.edu.notes.R;
import com.edu.notes.utlis.CheckUtils;
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(phone)){
                        if (mobile) {
                            ...
                            timer.start();
                            BmobSMS.requestSMSCode(getActivity(), phone, "短信",new RequestSMSCodeListener() {

                                @Override
                                public void done(Integer smsId,BmobException ex) {
                                    if(ex==null){//验证码发送成功
                                        Log.i("smile", "短信id："+smsId);
                                        showSnackar(view,"短信发送成功");
                                    }else{
                                        showSnackar(view,"短信发送失败"+"错误码"+smsId);
                                    }
                                }
                            });}else
                        {
            ...
            public void onClick(View v) {
                ...
                user.signOrLogin(getActivity(), code, new SaveListener() {
                    ...
                    public void onSuccess() {
                        ...
                        Log.i("smile", ""+ BmobUser.getCurrentUser(getActivity(),MyUser.class).getUsername()+"-"+user.getObjectId()+"-"+user.getEmail());
                    }
